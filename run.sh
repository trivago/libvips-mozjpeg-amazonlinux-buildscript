...
#
# Modifications: Copyright 2017 trivago GmbH
#
...
mkdir ${DEPS}/zlib
curl -Ls http://${SOURCEFORGE_MIRROR}.dl.sourceforge.net/project/libpng/zlib/${VERSION_ZLIB}/zlib-${VERSION_ZLIB}.tar.gz | tar xzC ${DEPS}/zlib --strip-components=1
cd ${DEPS}/zlib
